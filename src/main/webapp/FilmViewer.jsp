...
<body>
	...
	<img src="https://thumbs.dreamstime.com/b/movie-slate-film-reel-wood-clapper-wooden-backgorund-36502412.jpg" width="300" height="200" alt="stock cinema photo" />
		<p>Title: <strong>${film.title }</strong>
		<br>${film.desc }
	<ul>
